...
public class IPiState : IState
{
    float _stateEnterTime;
    protected PiStateController _stateMachine;
    protected Animator _animator;
    protected PlayableDirector _director;
    protected EnemyController _enemy;
    protected StateConfig_Pi _data;
    ...
    public void Initialize(PiStateController stateMachine, EnemyController enemy, Animator animator, PlayableDirector director, StateConfig_Pi data)
    {
